      ...
      >
        <div className="text-center max-w-md mx-auto p-4 sm:p-8">
          <div className="mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">文章链接无效</h2>
            <p className="text-gray-600 mb-6 text-sm sm:text-base">请检查文章链接是否正确</p>
            <Link 
              to="/"
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        ...
        >
          <div className="relative">
            ...
            <div className="text-base sm:text-lg font-medium text-gray-700">正在加载文章...</div>
          </div>
        </motion.div>
      </div>
    )
      ...
      >
        <div className="text-center max-w-md mx-auto p-4 sm:p-8">
          <div className="mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">文章不存在</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 sm:py-8">
        ...
        >
          <Link 
            to="/"
            className="inline-flex items-center px-3 sm:px-4 py-2 bg-white/80 backdrop-blur-sm text-gray-700 rounded-lg hover:bg-white transition-all duration-200 shadow-sm hover:shadow-md text-sm sm:text-base"
          >
            <ArrowLeft className="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
            返回首页
          </Link>
        ...
        >
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative p-4 sm:p-8 md:p-12">
              ...
              {post.categories && post.categories.length > 0 && (
                ...
                >
                  {post.categories.map((category) => (
                    <span
                      key={category.id}
                      className="inline-flex items-center px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium rounded-full mr-2 mb-2"
                      style={{ 
                    ...
                    >
                      <FolderOpen className="w-2 h-2 sm:w-3 sm:h-3 mr-1" />
                      {category.name}
                    </span>
                  ))}
                </motion.div>
              ...
              <motion.div 
                ...
                className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-3 sm:gap-6 text-xs sm:text-sm text-gray-600 mb-6 sm:mb-8"
              >
                ...
                <div className="flex items-center">
                  <Calendar className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-green-600" />
                  <span>{formatDate(post.publishedAt || post.createdAt || undefined)}</span>
                </div>
                
                <div className="flex items-center">
                  <Eye className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-purple-600" />
              ...
              {post.excerpt && (
                <motion.div 
                  ...
                  className="mb-6 sm:mb-8 p-4 sm:p-6 bg-blue-50 rounded-xl border-l-4 border-blue-500"
                >
          ...
          <motion.div 
            ...
            className="px-4 sm:px-8 md:px-12 pb-6 sm:pb-8 pt-6 sm:pt-8 border-t border-gray-100"
          >
            {/* 标签 */}
            {post.tags && post.tags.length > 0 && (
              <div className="mb-4 sm:mb-6">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 flex items-center">
                  <Tag className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-blue-600" />
                  标签
                </h3>
                <div className="flex flex-wrap gap-1 sm:gap-2">
                  {post.tags.map((tag) => (
                    <span
                      key={tag.id}
                      className="px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 rounded-full border border-blue-200 hover:from-blue-200 hover:to-indigo-200 transition-all duration-200 cursor-pointer"
                    >
                      #{tag.name}
                    </span>
                  ))}
            ...
            {/* 文章统计 */}
            <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center justify-between gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl">
        ...
        <motion.div 
          ...
          className="mt-6 sm:mt-8 bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-8"
        >
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">相关推荐</h3>
          <div className="text-center py-6 sm:py-8 text-gray-500">
            <div className="text-3xl sm:text-4xl mb-4">📚</div>
            <p className="text-sm sm:text-base">更多精彩内容正在准备中...</p>
          </div>
        </motion.div>
